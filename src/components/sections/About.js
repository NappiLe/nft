...
function About() {
  return (
    <Section id="about">
      ...
      <Box><Carousel /></Box>
      <Box>
        <Title>Welcome To The <br /> Koi Club.</Title>
        <SubText>The KOI CLUB is a private collection of NFTs—unique digital collectibles. The Weirdos are stored as ERC-721 tokens on the Ethereum blockchain and hosted on IPFS.</SubText>
